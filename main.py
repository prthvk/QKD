...
def step6():
    ...
    x1=0
    for i in range(len(temp_bit_list_alice)):
    	if temp_bit_list_alice[i]==1:
    		x1=x1+2**(len(temp_bit_list_alice)-1-i)
    print(f'The Key is {x1}')
...
def detailedPresentation(bit_size):
    ...
    print("The QBER is: " + str(100*qber_actual) + "%")
    print("The calculated secure key rate is: " + str(100*secureKeyRate(qber_calculated)) + "%")
    print("The secure key rate is: " + str(100*secureKeyRate(qber_actual)) + "%")
